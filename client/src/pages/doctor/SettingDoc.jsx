...
import ManageRecPopover from '../../components/app/doctor/ManageRecPopover';
...
const ReceptionistTab = () => (
  <div className="space-y-5">
    <div>
      <h1 className="text-2xl font-extrabold text-[#07122f] tracking-tight">Manage Receptionist</h1>
      <p className="mt-1 text-sm text-slate-400 font-medium">Link, manage, or remove your clinic receptionist.</p>
    </div>
    <Card>
      <ManageRecPopover isInline={true} setIsPopoverOpen={() => {}} />
    </Card>
  </div>
);
...
const SettingDoc = () => {
  ...
  const renderContent = () => {
    ...
    if (activeTab === 'receptionist') return <ReceptionistTab />;
